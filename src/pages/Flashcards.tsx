...
const Flashcards = () => {
  ...
  const handleGenerateFlashcards = async () => {
    ...
    setIsLoading(true);
    // TODO: Implement AI flashcard generation after backend setup
    setTimeout(() => {
      setIsLoading(false);
      toast({
        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-8 animate-fade-in">
            ...
            <p className="text-muted-foreground">
              Generate 5-7 key terms and definitions from your notes
            </p>
          </div>
          ...
          <div className="space-y-6">
            <Card className="glass-card animate-fade-in">
              <CardHeader>
                ...
                <CardDescription>
                  Paste your notes or upload a text file to generate flashcards
                </CardDescription>
              </CardHeader>
